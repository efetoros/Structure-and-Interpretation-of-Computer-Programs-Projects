    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 7
                # print(self.ant.can_contain(insect))
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 6A
        if not self.place.ant == None:
            if not self.place.ant.name == 'Ninja':
...
class Ant(Insect):
    ...
    def can_contain(self, other_ant):
        # print(other_ant.container)
        # print(self.container)
        # print(self.ant)

        if self.container == True and other_ant.container == False:
            if self.ant == None:
                return True
            else:
                return False
        ...
        # if other_ant.container == False and self.container == True or self.ant != None:
        #     return True
        # else:
        #     return False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        count = 0
        while thrower_place.entrance != hive.exit and count <= self.max_range:
            if thrower_place.bees != []:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            current_place.bees = [x for x in current_place.bees if x.armor > self.damage]
            for item in current_place.bees:
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        ...
        if len(self.place.bees) >= 1:
            self.place.bees = [x for x in self.place.bees if self.damage < x.armor]
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, colony):
        ...
        #     while queen_location.exit != None:
        #         queen_location = queen_location.exit
        #         if queen_location.ant != None:
        #             self.behind_ants = self.behind_ants + [queen_location.ant]
        #     for a in self.behind_ants:
        #         if a is a container
        #                 is there anything in it?
        #                     if, buff it 
        #                 is the container itself buffed?
        #                     if not, buff it 


        #         if not in self.buffed_ants
        #             buff it 



                # if a not in self.buffed_ants:
                #     if a.container == True and a.ant != None:
                #         print(a.ant.damage)
                #         a.damage = 1
                #         a.ant.damage = a.ant.damage * 2
                #         self.buffed_ants = self.buffed_ants + [a]
