...
(define (minus_one_plus_four x)
  (+ 4 (- x 1))) 
(minus_one_plus_four 9)
;expect 12

(define a 3)
(minus_one_plus_four a)
;expect 6

(quote (1 2 3 apple sandwich 42))
;expect (1 2 3 apple sandwich 42)
...
(begin (define x 7) (define y 2) (+ x y))
;expect 9

(define s (lambda (x y z) (+ x y z)))
(s 1 2 3)
;expect 6

(define (subtract_one x)
  (- x 1))
subtract_one
;expect (lambda (x) (- x 1))
...
(or (and nil 2 5) (or () 'hello))
;expect 5

(cond ((and nil 2) 'watermelon)
      ((or True (1/0)) 'pancakes)
      (else 7))
;expect watermelon

(define s (cond ((= 4 3) False)
      ((= 5 5) (lambda (x) (* x x)))))
(s 3)
;expect 9

(let ((s (lambda (x) (* x 10))) (k 10)) (s 10))
;expect 100

(define w (mu (a) (+ a b)))
(define k (lambda (a b) (w (+ a 100))))
(k 3 7)
;expect 110
